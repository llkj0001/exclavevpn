.class public final Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl$3;
...
.method public bridge synthetic bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/nekohasekai/sagernet/database/ProxyEntity_Dao_Impl$3;->bind(Landroidx/sqlite/SQLiteStatement;Lio/nekohasekai/sagernet/database/ProxyEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `proxy_entities` SET `id` = ?,`groupId` = ?,`type` = ?,`userOrder` = ?,`tx` = ?,`rx` = ?,`status` = ?,`ping` = ?,`uuid` = ?,`error` = ?,`socksBean` = ?,`httpBean` = ?,`ssBean` = ?,`ssrBean` = ?,`vmessBean` = ?,`vlessBean` = ?,`trojanBean` = ?,`naiveBean` = ?,`hysteria2Bean` = ?,`mieruBean` = ?,`tuic5Bean` = ?,`shadowtlsBean` = ?,`sshBean` = ?,`wgBean` = ?,`juicityBean` = ?,`http3Bean` = ?,`anytlsBean` = ?,`shadowquicBean` = ?,`trustTunnelBean` = ?,`configBean` = ?,`chainBean` = ?,`balancerBean` = ? WHERE `id` = ?"
