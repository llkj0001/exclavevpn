.class public final Lio/nekohasekai/sagernet/database/RuleEntity_Dao_Impl$3;
...
.method public bind(Landroidx/sqlite/SQLiteStatement;Lio/nekohasekai/sagernet/database/RuleEntity;)V
    ...
    .line 167
    invoke-virtual {v0, v1}, Lio/nekohasekai/sagernet/database/StringCollectionConverter$Companion;->fromSet(Ljava/util/Set;)Ljava/lang/String;
...
.method public bridge synthetic bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/nekohasekai/sagernet/database/RuleEntity_Dao_Impl$3;->bind(Landroidx/sqlite/SQLiteStatement;Lio/nekohasekai/sagernet/database/RuleEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `rules` SET `id` = ?,`name` = ?,`userOrder` = ?,`enabled` = ?,`domains` = ?,`ip` = ?,`port` = ?,`sourcePort` = ?,`network` = ?,`source` = ?,`protocol` = ?,`attrs` = ?,`outbound` = ?,`reverse` = ?,`redirect` = ?,`packages` = ?,`ssid` = ?,`networkType` = ? WHERE `id` = ?"
