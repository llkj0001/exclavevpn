...
# direct methods
.method public static T(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/stream/m2;
    .locals 6
    ...
    .line 0
    invoke-direct {v4, v0}, Lj$/util/stream/a;-><init>(I)V
    ...
    .line 0
    invoke-direct {v3, v0}, Lj$/util/stream/a;-><init>(I)V
    ...
    .line 0
    invoke-direct {v2, v0}, Lj$/util/stream/a;-><init>(I)V
    ...
    .line 65
    invoke-virtual {v0, p0, p1}, Lj$/util/stream/y3;->b(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-direct {p1, p0}, Lj$/util/stream/m2;-><init>(Ljava/util/Collection;)V
...
.method public final J(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/h2;
    ...
    .line 74
    invoke-virtual {p1, p2, v1, p3}, Lj$/util/stream/b;->B(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/h2;
    ...
    .line 509
    iget v0, p1, Lj$/util/stream/b;->f:I

    .line 76
    invoke-virtual {p3, v0}, Lj$/util/stream/c7;->d(I)Z
    ...
    .line 77
    invoke-static {p1, p2}, Lj$/util/stream/o;->T(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/stream/m2;
    ...
    invoke-direct {v3, v2, v1}, Lj$/util/stream/r0;-><init>(Ljava/util/function/Consumer;Z)V

    .line 173
    invoke-virtual {v3, p1, p2}, Lj$/util/stream/s0;->g(Lj$/util/stream/b;Lj$/util/Spliterator;)V
    ...
    invoke-direct {p2, p1}, Lj$/util/stream/m2;-><init>(Ljava/util/Collection;)V
...
.method public final K(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p1}, Lj$/util/stream/m2;->spliterator()Lj$/util/Spliterator;
    ...
    invoke-direct {v0, p1, p2}, Lj$/util/stream/l7;-><init>(Lj$/util/Spliterator;Lj$/util/concurrent/ConcurrentHashMap;)V
...
.method public final M(ILj$/util/stream/p5;)Lj$/util/stream/p5;
    ...
    .line 127
    invoke-direct {p1, p2}, Lj$/util/stream/m;-><init>(Lj$/util/stream/p5;)V
    ...
    .line 158
    invoke-direct {p1, p2}, Lj$/util/stream/n;-><init>(Lj$/util/stream/p5;)V
